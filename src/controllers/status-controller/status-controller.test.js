...
describe('status-controller', () => {
  ...
  describe('getStatus', () => {
    it('should return pipeline status', async () => {
      const { getStatus } = await import('../status-controller/index.js')
      const { getCurrentPipelineStatus } = await import('../../pipeline/index.js')
      getCurrentPipelineStatus.mockResolvedValue({
        running: false,
        status: 'idle',
        currentStep: null,
        progress: 0,
  ...
  describe('getHealth', () => {
    it('should return health status', async () => {
      const { getHealth } = await import('../status-controller/index.js')
  ...
  describe('handleMLWebhook', () => {
    it('should handle successful ML webhook', async () => {
      const { handleMLWebhook } = await import('../status-controller/index.js')
