...
create_vm() {
    ...
    sed -i "" "s#__BQ_PROJECT_ID__#${BQ_PROJECT_ID:-jfp-data-warehouse}#g" "$TEMP_CLOUD_CONFIG"
    sed -i "" "s#__BQ_DATASET__#${BQ_DATASET:-youtube}#g" "$TEMP_CLOUD_CONFIG"
    sed -i "" "s#__BQ_KEY_FILE__#${BQ_KEY_FILE:-./config/service-account-key.json}#g" "$TEMP_CLOUD_CONFIG"
